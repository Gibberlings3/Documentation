			   Baldur's Gate Mini-Questy i Spotkania
				   Modyfikacja 
	do oryginalnego BG1 (z lub bez OzWM), BG1Tutu v4, EasyTutu lub BGT 
			autorstwa jastey (jastey@web.de)
				    wersja 8.1


Jest to mini-modyfikacja do oryginalnego BG1 (z lub bez zainstalowanego rozszerzenia "Opowieœci z Wybrze¿a Mieczy"), BG1Tutu (v4), EasyTutu lub BGT, która wprowadza do gry kilka ma³ych questów. Mod zawiera w sobie mini-modyfikacjê "Quest ze szlamem", pierwotnie stanowi¹c¹ (zwyciêski) udzia³ we wrzeœniowym konkursie Black Wyrm Forum (http://www.blackwyrmlair.net/). 

Czas przejœcia modyfikacji wynosi ³¹cznie oko³o 30-60 minut, zale¿nie od stylu gry. 

ZAWARTOŒÆ

1. Przygoda ze Szlamem (w Beregoœcie)

Komponent wprowadza nowy quest na obszarze Beregostu. Jeœli przejdziecie ko³o jednego domu w pó³nocno-zachodniej czêœci Beregostu, zaczepi was na czerwono ubrana kobieta. Coœ dziwnego dzieje siê w domu jej s¹siada i kobieta prosi was o pomoc... Quest zosta³ przerobiony, aby pokonaæ znane problemy z kompatybilnoœci¹ i do³¹czyæ rozwi¹zanie questu dla z³ych postaci. 

2. K³ótnia Rodzinna w Beregoœcie
...
3. Opieka nad Dzieæmi w Nashkel, zawiera spotkanie na Jarmarku
...
Quest da siê rozwi¹zaæ, je¿eli g³ówna postaæ jest paladynem lub reputacja dru¿yny wy¿sza ni¿ 12.

Na jarmarku spotkacie m³od¹ kobietê imieniem Tina. Pilnie potrzebuje pieniêdzy i szuka pracy... przynajmniej tak mówi.

4. Potwór w Nashkel

W pobli¿u szlacheckiej rezydencji w Nashkel nada¿y siê okazja uratowania ma³ego Armina z paszczy potwora. Za taki czyn mo¿ecie byæ pewni wdziêcznoœci rodziców... prawda?

5. Upad³y Paladyn we Wrotach Baldura

W pó³nocnej czêœci miasta, w œwi¹tyni Helma, ukry³ siê z³y, upad³y paladyn. Bez wahania brutalnie zaszlachtowa³ ma³¹ dziewczynkê... Tak przynajmniej twierdz¹ wzburzeni ludzie zebrani przed œwi¹tyni¹.

6. Nieœmiertelna Mi³oœæ w Wiosce Rybackiej
...
8. Nieoczekiwana Pomoc

W infirmerii Candlekeep przebywa pogr¹¿ony w myœlach sir Trun. Zosta³ ciê¿ko ranny w ostatniej walce, ale to wydaje siê go mniej martwiæ ni¿ fakt, ¿e prze¿y³ tylko dziêki nieoczekiwanej pomocy. Mo¿e coœ wiêcej wie Linda, lekko zdesperowana kobieta w gospodzie Candlekeep...
Ten quest jest dostêpny zarówno w prologu, jak i póŸniej, po powrocie do Candlekeep. 

9. Rozszerzenie Spotkania z Bjorninem

Bjornin, ranny paladyn w Beregoœcie, zawsze mnie fascynowa³. Moja g³ówna postaæ chêtnie pogada³a by z nim szerzej...
Ten komponent umo¿liwia postaci o reputacji wy¿szej ni¿ 9 przeprowadzenie d³u¿szej rozmowy z Bjorninem. 


INSTALACJA

Dla wszystkich wersji (Windown, Mac OS X, Linux):

Dla bezpieczeñstwa nale¿y przed instalacj¹ sporz¹dziæ kopie plików Dialog.tlk i Dialogf.tlk. Zawartoœæ archiwum moda rozpakuj do g³ównego folderu gry (Baldur's Gate, BGT lub BG1Tutu / EasyTutu. Rozpoznanie rodzaju instalacji nast¹pi automatycznie.)

Uwaga: Przed instalacj¹ moda nale¿y odinstalowaæ wszystkie wersje mini-moda "Quest ze szlamem". Mod nie rozpoznaje tej sytuacji automatycznie! Równie¿ odinstaluj i skasuj star¹ wersjê BGQE przed wypakowaniem zawartoœci tego moda do folderu gry.


Windows
Uruchom "Setup-JasteysBG1Quests.exe" podwójnym klikniêciem. Wybierz wersjê jêzykow¹ i potwierdŸ rozpoczêcie instalacji. Teraz zostan¹ skopiowane niezbêdne dane i przeprowadzona instalacja. 

Mac OS X
Upewni siê, ¿e œci¹gn¹³eœ wersjê moda dla systemu Mac OS X ("OSX-BGQE-vx.zip"). Po prawidowym rozpakowaniu w g³ównym katalogu gry powinien znajdowaæ siê folder bgqe, setup-bgqe i setup-bgqe.command. Aby zainstalowaæ podwójnie kliknij na setup-bgqe.command i postêpuj wed³ug instrukcji na ekranie.

Linux
Upewnij siê, ¿e masz wersjê moda dla systemu Linux (plik "lin-bgqe-vx.zip")
Œci¹gnij najnowsz¹ wersjê WeiDU dla Linux z WeiDU.org i skopiuj WeiDU oraz WeInstall do /usr/bin. Nastepnie otwórz terminal, przejdŸ do katalogu instalacyjnego BG, uruchom 'tolower' i odpowiedz TAK na oba pytania. Mo¿esz pomin¹æ drug¹ opcjê (linux.ini), jeœli chocia¿ raz by³a ju¿ uruchamiana w tym katalogu. Dla zaoszczêdzenia czasu pliki archiwum sa juz "tolowered", wiêc nie ma potrzeby uruchamiania tak¿e pierwszej opcji (ustawienie ma³ych liter w nzwach plików), o ile rozpakowywa³eœ wy³¹cznie ten mod od czasu ostatniego uruchomienia opcji ustawienia ma³ych liter w nazwach plików. Je¿eli nie masz pewnoœci, najbezpieczniej jest uruchomiæ 'tolower' i wybraæ obie opcje.
Uruchom WeInstall setup-bgqe w katalogu z gr¹, aby zainstalowaæ mod. Nastêpnie uruchom "wine BGMain.exe" i zacznij grê.

Nie trzeba zaczynaæ gry od nowa, aby móc w pe³ni przejœæ modyfikacjê.

Gdyby podczas instalacji wyst¹pi³y b³êdy, proszê zwróciæ siê do mnie przedstawiaj¹c zawartoœæ pliku "setup-log" na podany powy¿ej adres e-mail lub (lepiej) na forum:

Bezpoœrednie linki: 
Angielskie forum: http://forums.gibberlings3.net/index.php?s=cf605c1c14a55eb2af1014878e36d487&showforum=148

Niemiecki w¹tek (Rosenranken): http://www.rosenranken.org/index.php?topic=7647.0

Niemiecki w¹tek (Kerzenburgforum): http://kerzenburg.baldurs-gate.eu/showthread.php?t=36870
...
Dla BG1 mod powinien byæ kompatybilny z (co nie znaczy, ¿e wszystkie wymienione mody s¹ na pewno kompatybilne miêdzy sob¹):
-Echons "Field of the Dead" (Version 1.07)
...
Dla Tutu mod powinien byæ kompatybilny z (co nie znaczy, ¿e wszystkie wymienione mody s¹ na pewno kompatybilne miêdzy sob¹):
BG1 NPC Project
-BG1 Unfinished Business
-Grey Clan Episode 1
-Herbs and Potions Add-In
...
Interesuj¹ mnie bardzo wasze doœwiadczenia dotycz¹ce kompatybilnoœci tego moda z innymi. Proszê, dawajcie mi znaæ, z jakimi innymi modami graliœcie w t¹ modyfikacjê, tak¿e (szczególnie wtedy) gdy nie napotkaliœcie ¿adnych problemów.


Dziêkujê wszystkim, którzy mi pomogli w tworzeniu tej modyfikacji.
